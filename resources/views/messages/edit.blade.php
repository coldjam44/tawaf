        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">{{ trans('main_trans.edit_message') }}</h4>
                    <div>
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <div class="card-body text-center">
                                        <div class="mb-3">
                                            <img id="imagePreview" src="{{ $message->image_path ? asset('messagesfiles/' . $message->image_path) : asset('admin/img/no-image.png') }}" 
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if($message->image_path)
                                                <small class="text-muted">{{ trans('main_trans.current_image') }}: {{ $message->image_path }}</small>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="name_en" id="name_en" class="form-control @error('name_en') is-invalid @enderror" 
                                                   value="{{ old('name_en', $message->name_en) }}" required>
                                            @error('name_en')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="name_ar" id="name_ar" class="form-control @error('name_ar') is-invalid @enderror" 
                                                   value="{{ old('name_ar', $message->name_ar) }}" required>
                                            @error('name_ar')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="position_en" id="position_en" class="form-control @error('position_en') is-invalid @enderror" 
                                                   value="{{ old('position_en', $message->position_en) }}" required>
                                            @error('position_en')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="position_ar" id="position_ar" class="form-control @error('position_ar') is-invalid @enderror" 
                                                   value="{{ old('position_ar', $message->position_ar) }}" required>
                                            @error('position_ar')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea name="message_en" id="message_en" rows="8" class="form-control @error('message_en') is-invalid @enderror" required>{{ old('message_en', $message->message_en) }}</textarea>
                                            @error('message_en')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea name="message_ar" id="message_ar" rows="8" class="form-control @error('message_ar') is-invalid @enderror" required>{{ old('message_ar', $message->message_ar) }}</textarea>
                                            @error('message_ar')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
