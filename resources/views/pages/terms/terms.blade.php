    ...
    <div class="col-xl">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="text-center my-4"> {{ trans('main_trans.term') }}</h3>
                <div class="text-right mb-3">
                    @can('create apartments')
                    <a href="{{ route('terms.create') }}" class="btn-bid-now" style="color:white; cursor:pointer">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="{{ route('terms.update',$term->id) }}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <label for="description_ar" class="mr-sm-2">
                                                                    {{ trans('Counters_trans.description_ar') }} :
                                                                </label>
                                                                <textarea id="description_ar" name="description_ar" class="form-control" rows="3" required>{{ $term->description_ar }}</textarea>
                                                                <input id="id" type="hidden" name="id" class="form-control" value="{{ $term->id }}">
                                                            </div>
                                                            <div class="col">
                                                                <label for="description_en" class="mr-sm-2">
                                                                    {{ trans('Counters_trans.description_en') }} :
                                                                </label>
                                                                <textarea id="description_en" name="description_en" class="form-control" rows="3" required>{{ $term->description_en }}</textarea>
                                                            </div>
                                                        </div>
                        ...
                        <form action="{{ route('terms.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row d-flex flex-row">
                                ...
                                <div class="col" style="width: 50%">
                                    ...
                                    <textarea id="description_en" name="description_en" class="form-control" rows="3" required></textarea>
                                </div>
                            </div>
