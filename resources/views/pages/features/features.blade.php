    ...
    <div class="col-xl">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="text-center my-4"> {{ trans('main_trans.feature') }}</h3>
                <div class="text-right mb-3">
                    @can('create apartments')
                    <a href="{{ route('features.create') }}" class="btn-bid-now" style="color:white; cursor:pointer">
                        ...
                        <tbody>
                            ...
                            @foreach ($features as $feature)
                                ...
                                <tr>
                                    ...
                                    <td>{{ App::getLocale() == 'ar' ? $feature->hotel->name_ar : $feature->hotel->name_en }}</td>
