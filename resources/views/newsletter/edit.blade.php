...
@section('title', trans('main_trans.edit') . ' ' . trans('main_trans.newsletter'))
                    ...
                    <div class="col-12">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h5 class="card-title text-primary">{{ trans('main_trans.edit') }} {{ trans('main_trans.newsletter') }}</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror" 
                                               id="email" name="email" value="{{ old('email', $newsletter->email) }}" 
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('message') is-invalid @enderror" 
                                                  ...
                                                  placeholder="{{ trans('main_trans.message') }}">{{ old('message', $newsletter->message) }}</textarea>
                                        @error('message')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
