    ...
    <div class="col-xl">
        <div class="card mb-4">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                <div>
                    <h3 class="text-center my-4">{{ trans('main_trans.add_project_description') }}</h3>
            ...
            <div class="card-body">
                ...
                {{-- فورم الإضافة --}}
                <form action="{{ route('project-descriptions.store', $project->id) }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea name="content_ar" id="content_ar" class="form-control @error('content_ar') is-invalid @enderror" rows="10" required>{{ old('content_ar') }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea name="content_en" id="content_en" class="form-control @error('content_en') is-invalid @enderror" rows="10" required>{{ old('content_en') }}</textarea>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="location_address_ar" id="location_address_ar" class="form-control @error('location_address_ar') is-invalid @enderror" value="{{ old('location_address_ar') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="location_address_en" id="location_address_en" class="form-control @error('location_address_en') is-invalid @enderror" value="{{ old('location_address_en') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" name="google_location" id="google_location" class="form-control @error('google_location') is-invalid @enderror" value="{{ old('google_location') }}" placeholder="https://maps.google.com/...">
