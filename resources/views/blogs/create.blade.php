                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="content_ar" id="content_ar" class="form-control @error('content_ar') is-invalid @enderror" rows="12" required>{{ old('content_ar') }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="content_en" id="content_en" class="form-control @error('content_en') is-invalid @enderror" rows="12" required>{{ old('content_en') }}</textarea>
