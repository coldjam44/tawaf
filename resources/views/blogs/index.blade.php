        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('blogsection.create') }}" class="btn btn-primary">
                ...
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('blogsection.show', $blog->id) }}" class="btn btn-sm btn-info" title="{{ trans('main_trans.view') }}">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="{{ route('blogsection.edit', $blog->id) }}" class="btn btn-sm btn-warning" title="{{ trans('main_trans.edit') }}">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <form action="{{ route('blogsection.destroy', $blog->id) }}" method="POST" class="d-inline" onsubmit="return confirm('{{ trans('main_trans.confirm_delete') }}')">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-sm btn-danger" title="{{ trans('main_trans.delete') }}">
                    ...
                    @else
                        <div class="text-center py-4">
                            ...
                            <a href="{{ route('blogsection.create') }}" class="btn btn-primary mt-2">
                                <i class="fas fa-plus me-1"></i>
                                {{ trans('main_trans.add_blog') }}
                            </a>
                        </div>
